...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            [
                'asin' => '4023318787',
                'name' => '本当の自由を手に入れる お金の大学',
                'description' => '
                youtubeで大人気のチャンネルから本が出ました！お金の勉強にはもってこいだと思います。以下概要です。
                61万部突破! いま一番売れてる「お金の勉強」本。
